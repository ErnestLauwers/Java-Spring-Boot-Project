...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/regatta/overview", "/regatta/searchAndSort").hasAnyRole("ADMIN", "USER")
                .requestMatchers( "/storage/overview", "/storage/search", "/storage/sort/*").hasAnyRole("ADMIN", "USER")
